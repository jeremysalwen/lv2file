CFLAGS = -O3 -Wall -Wextra --std=c99 `pkg-config --cflags argtable2 sndfile lilv-0 lv2`
...
lv2file: lv2file.o midi_input.o event_buffer.o
	$(CC) $(LDFLAGS) lv2file.o -o lv2file $(LDLIBS)
midi_input.o: midi_input.c
	$(CC) -c $(CFLAGS) -O0 -g -o midi_input.o midi_input.c
midi: midi_input.o event_buffer.o symap.o
